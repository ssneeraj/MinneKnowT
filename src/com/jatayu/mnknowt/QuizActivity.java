...
public class QuizActivity extends ListActivity {
	...
	private void showSingleQandA() {
		...
		quizQuestionNumberText.append("Question ");
		...
		quizQuestionNumberText.append(" : ");
		quizQuestionNumberText.append(singleQandA.getQuestionText());

		TextView question = (TextView) this
				.findViewById(R.id.questionText);
		question.setText(quizQuestionNumberText.toString());
