...
public class QuizHomeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.quizhomelayout);
	}

	/*
	 * This method is called from the quizhomelayout onClick
	 */
	public void showQuizActivity(View view) {
		new SetupQuizTask(QuizHomeActivity.this).execute();
	}
	...
	private class SetupQuizTask extends AsyncTask<Void, Void, Boolean> {
		...
		private QuizHomeActivity activity;

		public SetupQuizTask(QuizHomeActivity quizhomeActivity) {
			this.activity = quizhomeActivity;
		...
		protected void onPostExecute(Boolean parserResult) {
			...
			if (parserResult) { // If quiz was successfully parsed
				Intent intent = new Intent(QuizHomeActivity.this,
						QuizActivity.class);
